...
class MainFormClustering:
    def __init__(self, parent):
        ...
        self.root.geometry('570x590')# Set the window size
    ...
    def create_input_frame(self):
        ...
        # create a back button in the input_btns_frame
        self.back_btn = ttk.Button(self.input_btns_frame, text='Back to Main', width=20,
                                   command=self.go_back, style='TButton')
        self.back_btn.grid(row=1, column=0, columnspan=2, padx=10, pady=5, sticky='ew')
    ...
    def crete_results_frame(self):
        ...
        """
        self.result_frame = tk.Frame(self.root, relief='groove', bd=2) # Create a frame for results
        self.result_frame.grid(row=1, column=0, padx=(10,0), pady=(10,0), sticky='nsew')
        self.pairplot_btn = ttk.Button(self.result_frame, text='Pair Plot Chart', command=self.open_pairPlot, style='TButton')# Button for pair plot
        self.pairplot_btn.grid(row=0, column=0, padx=10, pady=10, sticky='w')
        self.corrPlot_btn = ttk.Button(self.result_frame, text='Correlation Matrix', command=self.open_corrPlot, style='TButton') # Button for correlation matrix
        self.corrPlot_btn.grid(row=0, column=1, padx=10, pady=10, sticky='w')
        self.boxPlot_btn = ttk.Button(self.result_frame, text='Box Plot Chart', command=self.open_boxPlot, style='TButton') # Button for box plot
        self.boxPlot_btn.grid(row=1, column=0, padx=10, pady=10, sticky='w')
        self.boxPlot_btn = ttk.Button(self.result_frame, text='Kmeans elbow Result', command=self.open_inertiaPlot, style='TButton')  # Button for KMeans elbow plot
    ...
    def create_progress_frame(self):
        ...
        """
        self.progress_frame = tk.Frame(self.root, relief='groove')  # Create a frame for progress
        self.progress_frame.grid(row=1, column=1, padx=10, pady=(10,0), sticky='nsew')
        self.status_text = tk.Text(self.progress_frame, height=10, width=33, wrap=tk.WORD, font=('Arial', 8))  # Text widget for status messages
    ...
    def create_table_frame(self):
        ...
        self.table_frame = tk.Frame(self.root, relief='groove', width=500, height=200) # Create a frame for the table
